    ...
    return mainelement(
        *(
            div(
                h1(
                    f"#{blog[0]}:",
                    classname="bg-linear-to-r from-red-500 to-blue-500 text-transparent bg-clip-text transform origin-left transition-all hover:cursor-default  text-shadow shadow-lg text-3xl",
                ),
                div(
